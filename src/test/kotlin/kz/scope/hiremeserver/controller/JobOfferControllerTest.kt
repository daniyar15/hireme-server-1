...
//
//        // without authorization header
//        mvc.perform(MockMvcRequestBuilders.get("/api/job-offers/find-by-role?role=developer"))
//                .andExpect(MockMvcResultMatchers.status().isUnauthorized)
//
...
//
//        // without authorization header
//        mvc.perform(MockMvcRequestBuilders.get("/api/job-offers/find-by-skills?skills=java"))
//                .andExpect(MockMvcResultMatchers.status().isUnauthorized)
//
...
//                        description_of_responsibilities = "something",
//                        skills = "java",
//                        role = "tester",
//                        company_id = 9,
//                        job_type = "full-time")))
